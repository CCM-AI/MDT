...
responses = {
    ...
    "What are the symptoms of diabetes": "Symptoms include increased thirst, frequent urination, and fatigue.",
    "How is diabetes diagnosed": "Diagnosis is through blood tests that measure glucose levels.",
    ...
    "How important is exercise for managing diabetes": "Regular exercise helps control blood sugar levels.",
    "What should I do if my blood sugar is too high": "Monitor your levels, stay hydrated, and consult your healthcare provider.",
    "What is hypoglycemia": "Hypoglycemia is low blood sugar, which can cause dizziness, sweating, and confusion.",
    "What are the long-term complications of diabetes": "Complications can include heart disease, nerve damage, and kidney disease.",
    "How can I prevent complications from diabetes": "Manage blood sugar levels and have regular check-ups.",
    "What are some common treatments for diabetes": "Treatments can include insulin therapy and oral medications.",
    "How does stress affect diabetes": "Stress can raise blood sugar levels.",
    "What is the A1C test": "The A1C test measures average blood sugar levels over the past 2-3 months.",
    "What role does monitoring play in diabetes management": "Regular monitoring helps track blood sugar levels and adjust treatment.",
    "Can diabetes be reversed": "Type 2 diabetes may be reversed with significant lifestyle changes.",
    "What is gestational diabetes": "Gestational diabetes occurs during pregnancy and usually resolves after delivery.",
    "How often should I check my blood sugar": "Frequency depends on your treatment plan; consult your doctor.",
    "What are the signs of diabetic neuropathy": "Signs can include numbness, tingling, and pain in the extremities.",
    "What is diabetic retinopathy": "A condition that affects the eyes and can lead to blindness if untreated.",
    "How can I manage my weight with diabetes": "Focus on a balanced diet and regular exercise.",
    "What should I do if I feel unwell and have diabetes": "Monitor your blood sugar and consult your healthcare provider.",
    "Are there specific diets recommended for diabetes": "Mediterranean or low-carb diets are often recommended.",
    "What is the role of carbohydrates in a diabetic diet": "Carbohydrates affect blood sugar levels, so they should be monitored.",
    "How can I educate others about my diabetes": "Share information about your condition and management plan.",
    "Can I eat sweets if I have diabetes": "Sweets can be consumed in moderation with careful monitoring.",
    "What are the best sources of protein for diabetics": "Lean meats, fish, beans, and nuts are good options.",
    "What should I know about diabetes and alcohol": "Moderation is key; alcohol can affect blood sugar levels.",
    "How can I manage my diabetes while traveling": "Plan ahead, pack snacks, and keep medications accessible.",
    "What is the role of support groups in diabetes management": "Support groups can provide encouragement and shared experiences.",
    "What are the warning signs of diabetes": "Frequent urination, increased thirst, and unexplained weight loss.",
    "Can diabetes affect mental health": "Yes, living with diabetes can lead to stress and anxiety.",
